...
export default function OurStory() {
  return (
    <section className="bg-[url('/story.png')] bg-cover bg-center bg-no-repeat mt-[-25px] py-12 px-6 bg-gray-50 border-x-[20px] border-t-[20px] border-[#3B42D2] border-double">
